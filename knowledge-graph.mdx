...
On top of document linking and entity resolution, Ravell builds a **product intelligence** layer. It automatically extracts product entities — problems, feature requests, and topics — from your indexed documents, scores them by priority, and detects trends like rising problems and blind spots.

This transforms the knowledge graph from a retrieval tool into a continuous product health monitor. See [Product intelligence](/product-intelligence) for the full details.
...
- **Your interactions** with product intelligence (reviewing, dismissing, merging entities) improve scoring accuracy
...
<CardGroup cols={2}>
  ...
  <Card title="Product intelligence" icon="chart-mixed" href="/product-intelligence">
    Scored problems, blind spots, and weekly briefs from your knowledge graph.
  </Card>
