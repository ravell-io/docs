...
The knowledge graph doesn't just power search — it also feeds **Product Intelligence**, Ravell's automatic system for detecting problems, tracking feature requests, and surfacing trends. As entities are resolved and linked, Product Intelligence scores them by priority, detects emerging issues, and tracks whether your team has responded.

See [Product Intelligence](/product-intelligence) for the full guide.
...
<CardGroup cols={2}>
  <Card title="Product Intelligence" icon="chart-mixed" href="/product-intelligence">
    Automatic problem detection and trend analysis built on the knowledge graph.
  </Card>
