...
- **Entity graph** — retrieve documents by or about a specific entity
- **Product graph** — find answers through structured relationships between problems, features, decisions, and product areas
...
The [Knowledge API](/knowledge-api) provides programmatic access to these capabilities for building custom integrations and automated workflows.
