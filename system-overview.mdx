...
- **Product graph** — a structured layer that tracks problems, features, decisions, and product areas extracted from your documents, with scored relationships and blind spot detection

When you ask a question, Ravell classifies intent, plans retrieval, and searches across these lanes — including the product graph for questions about customer problems, feature coverage, and product priorities. Results are fused, filtered, and re-ranked so the best evidence surfaces first.
