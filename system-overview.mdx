...
| **Product Intelligence Brief** | Inbox, optionally Slack | Weekly schedule (automatic) |
...
The **Product Intelligence Brief** goes further — it ranks problems by priority, flags blind spots, tracks velocity trends, and measures the impact of shipped features. See [Product intelligence](/product-intelligence) for details.
...
<CardGroup cols={2}>
  ...
  <Card title="Product intelligence" icon="chart-mixed" href="/product-intelligence">
    Ranked problems, blind spots, and a weekly brief.
  </Card>
</CardGroup>
