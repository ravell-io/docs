...
On top of the Knowledge Graph, a **product graph** automatically extracts product problems, feature requests, and topics from your indexed documents. Each problem is scored by evidence strength, recency, source diversity, velocity, and team engagement. The product graph also detects **blind spots** — rising problems with no feature request addressing them — and can deliver a **weekly intelligence brief** to Slack with ranked problems, blind spots, and changes since the last report. See [Knowledge graph](/knowledge-graph#product-graph) for details.
